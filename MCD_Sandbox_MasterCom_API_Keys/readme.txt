  ...
  ----------------------
  Java keytool:
  keytool -storetype PKCS12 -list -keystore MasterCom-sandbox.p12 -storepass keystorepassword -v

  OpenSSL:
  openssl pkcs12 -info -in MasterCom-sandbox.p12 -password pass:keystorepassword
